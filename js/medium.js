(function() {
  ...
  const imageOptions = [
    'assets/medium/abstract-1.jpg',
    'assets/medium/abstract-2.jpg',
    'assets/medium/abstract-3.jpg',
    'assets/medium/abstract-4.jpg',
    'assets/medium/abstract-5.jpg'
  ];
  ...
  function startBackgroundMusic() {
    if (window.GameSettings && window.GameSettings.startMusic) {
      ...
      console.log('Background music started from Medium page');
    }
  }

  // ================= SETTINGS INTEGRATION =================
  function applyCurrentSettings() {
    console.log('Applying settings to Medium page');
  ...
  function saveGameResult() {
    if (checkWinCondition() && window.StatisticsManager) {
      window.StatisticsManager.addGameResult('medium', timerSeconds, moveCount, true);
    }
  }

  window.goToHard = function() {
    ...
    messageDiv.innerHTML = `
        <div class="completion-content">
            ...
            <div class="popup-buttons">
                ...
                <button onclick="goToHard()" class="popup-btn next-btn">▶️ Next</button>
            </div>
        </div>
    `;
  ...
  function checkWin() {
    if (checkWinCondition() && !gameCompleted) {
      gameCompleted = true;
      stopTimer();
      if (msgEl) msgEl.textContent = '✨ PERFECT! Medium puzzle complete! ✨';
